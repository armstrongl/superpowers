...
SOURCES = [
    {
        ...
        "filename": "azure-agent-design-patterns.md",
        "description": "Microsoft Azure AI agent orchestration design patterns — covers sequential, routing, handoff, and hierarchical patterns.",
    },
    {
        "url": "https://openai.github.io/openai-agents-python/multi_agent/",
        "filename": "openai-multi-agent-orchestration.md",
        "description": "OpenAI Agents SDK multi-agent orchestration guide — handoffs, agent-as-tool, and delegation patterns.",
    },
    {
        "url": "https://blog.langchain.com/how-and-when-to-build-multi-agent-systems/",
        "filename": "langchain-when-to-use-multi-agent.md",
        "description": "LangChain guidance on how and when to build multi-agent systems — decision criteria and pattern selection.",
    },
]
# ===========================================================================
