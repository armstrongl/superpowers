...
SOURCES = [
    {
        ...
        "filename": "anthropic-best-practices.md",
        "description": "Anthropic official skill authoring best practices.",
    },
    {
        "url": "https://docs.anthropic.com/en/docs/agents-and-tools/agent-skills/overview",
        "filename": "anthropic-skills-overview.md",
        "description": "Anthropic official skills overview and concepts.",
    },
]
# ===========================================================================
