...
SOURCES = [
    {
        ...
        "filename": "claude-code-agent-teams.md",
        "description": "Claude Code official documentation for agent teams and parallel orchestration.",
    },
    {
        "url": "https://www.anthropic.com/engineering/multi-agent-research-system",
        "filename": "anthropic-multi-agent-research-system.md",
        "description": "Anthropic engineering post on how their multi-agent research system was built.",
    },
    {
        "url": "https://learn.microsoft.com/en-us/azure/architecture/ai-ml/guide/ai-agent-design-patterns",
        "filename": "azure-ai-agent-design-patterns.md",
        "description": "Azure Architecture Center guide on AI agent orchestration design patterns.",
    },
]
# ===========================================================================
    ...
    for source in SOURCES:
        ...
        try:
            ...
            if not content.strip():
                print("  WARNING: Extracted content is empty. Skipping.")
