...
SOURCES = [
    {
        ...
        "filename": "agentskills-specification.md",
        "description": "Official Agent Skills open specification (agentskills.io).",
    },
    {
        "url": "https://code.claude.com/docs/en/skills",
        "filename": "claude-code-skills.md",
        "description": "Claude Code official skills documentation.",
    },
    {
        "url": "https://platform.claude.com/docs/en/agents-and-tools/agent-skills/overview",
        "filename": "claude-api-agent-skills-overview.md",
        "description": "Claude API Agent Skills overview on platform.claude.com.",
    },
]
# ===========================================================================
