...
SOURCES = [
    {
        ...
        "filename": "martinfowler-tdd.md",
        "description": "Martin Fowler's canonical TDD bliki entry: red-green-refactor cycle and principles.",
    },
    {
        "url": "https://tidyfirst.substack.com/p/canon-tdd",
        "filename": "kent-beck-canon-tdd.md",
        "description": "Kent Beck's 'Canon TDD' post clarifying the authoritative methodology directly from its creator.",
    },
    {
        "url": "https://tdd.mooc.fi/1-tdd/",
        "filename": "tdd-mooc-chapter1.md",
        "description": "TDD MOOC Chapter 1: What is TDD — structured academic introduction to the discipline.",
    },
]
# ===========================================================================
