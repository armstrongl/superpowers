...
SOURCES = [
    {
        ...
        "filename": "git-worktree-official.md",
        "description": "Official git-scm documentation for git-worktree command. "
                       "Covers all subcommands (add, list, lock, move, prune, remove, repair, unlock), "
                       "flags, and behavior details.",
    },
    {
        "url": "https://www.kernel.org/pub/software/scm/git/docs/git-worktree.html",
        "filename": "git-worktree-kernel.md",
        "description": "Kernel.org man page for git-worktree. "
                       "Authoritative low-level reference for flags and edge cases.",
    },
    {
        "url": "https://www.datacamp.com/tutorial/git-worktree-tutorial",
        "filename": "git-worktree-best-practices.md",
        "description": "DataCamp tutorial covering best practices for git worktree "
                       "in parallel development workflows, including AI agent patterns.",
    },
]
# ===========================================================================
