...
git clone https://github.com/armstrongl/superpowers.git "%USERPROFILE%\.config\opencode\superpowers"
...
```powershell
# 1. Install Superpowers
git clone https://github.com/armstrongl/superpowers.git "$env:USERPROFILE\.config\opencode\superpowers"
